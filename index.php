...
cabecera("Bienvenidos a la hora de pancho");
?>
<!DOCTYPE html>
<html lang="en">
...
<!-- //nav -->
<!-- AQUI VA EL BANNER GRANDE -->
<!-- banner-bottom -->

	<div class="banner-bottom">
	<h4 class="latest-text w3_latest_text">Episodios Recientes</h4>
		<div class="container">
...
<div class="general_social_icons">
	<nav class="social">
		<ul>
			<li class="w3_twitter"><a href="https://twitter.com/Theflashlatam" target='_blank'>Twitter <i class="fa fa-twitter"></i></a></li>
			<li class="w3_facebook"><a href="https://www.facebook.com/TFUniverse/" target='_blank'>Facebook <i class="fa fa-facebook"></i></a></li>
			<li class="w3_dribbble"><a href="http://www.theflashuniverse.com" target='_blank'>Web <i class="fa fa-dribbble"></i></a></li>
